...
class Arguments(object):
    ''' Holds arguments used by the Wifite2 '''
    ...
    def get_arguments(self):
        ...
        self._add_wpa_args(parser.add_argument_group(Color.s('{C}WPA2{W}')))
    ...
    def _add_wpa_args(self, wpa):
        wpa.add_argument('--wpa',
            action='store_true',
            dest='wpa_filter',
            help=Color.s('Show only {C}WPA2-encrypted networks{W} (includes {C}WPS{W})'))
        ...
        wpa.add_argument('--wpat',
            ...
            metavar='[seconds]',
            type=int,
            help=self._verbose('Time to wait before failing WPA2 attack ' +
