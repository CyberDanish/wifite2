...
class Configuration(object):
    ''' Stores configuration variables and functions for Wifite2. '''
    version = '2.2.5'
    ...
    def parse_pmkid_args(cls, args):
        if args.use_pmkid_only:
            ...
            Color.pl('{+} {C}option:{W} will ONLY use {C}PMKID{W} attack on WPA2 networks')
